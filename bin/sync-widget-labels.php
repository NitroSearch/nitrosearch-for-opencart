 ...
 * PrestaShop since its 1.3.0. This module has not, which meant a German shop
 * running a German back office showed its shoppers an English search panel.
 *
 ...
 * rather than at render time. OpenCart's own language files have no plural
 * machinery at all: a string is a string, and a module wanting "1 result" and
 * "5 results" is expected to write the branch itself. Resolving the CLDR
 * categories offline means neither major is ever asked a question it has no way
 * to answer.
 *
 * @package NitroSearch
 */
...
// this module's src/ carries one, and writing one produced a file the resolver
// then tried to read as a catalogue.
